...
namespace Tracker.Components
{
	...
	public sealed class ApplyOptiTrackTransformComponent : GH_Component
	{
		...
		public ApplyOptiTrackTransformComponent()
			: base("Apply OptiTrack Transform", "ApplyXForm", "Apply a transform to geometry for calibration/world mapping workflows.", "Tracker", "Geometry")
		{
		}
