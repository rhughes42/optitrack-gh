...
namespace Tracker.Components {
	...
	public sealed class VelocityAccelerationEstimateComponent : GH_Component {
		...
		public VelocityAccelerationEstimateComponent()
			: base( "Velocity / Acceleration Estimate", "VelAcc", "Estimate velocity and acceleration from point samples and timestamps.", "Tracker", "Calibration" ) {
		}
