...
namespace OptiTrack.Geometry {
	...
	public static class OptiTrackGeometryConverter {
		...
		public static Plane RigidBodyPoseToPlane( Point3d origin, Quaternion quaternion, double scaleFactor, bool yUp, AxisRemapMode axisRemapMode, Transform worldTransform ) {
		...
		public static Transform RigidBodyPoseToTransform( Point3d origin, Quaternion quaternion, double scaleFactor, bool yUp, AxisRemapMode axisRemapMode, Transform worldTransform ) {
