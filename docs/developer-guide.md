...
## v1.8.0 Manual Validation Checklist

The repository currently does not include a standalone unit test project for Tracker internals. For v1.8.0, run this manual validation:
